...
# Breaking change
This version does not include gunicorn and uvicorn as dependencies. As such you
would have to install them as you extend this image. This is to mitigate the resulting
image size.
